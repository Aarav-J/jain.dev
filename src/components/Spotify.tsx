    ...
    return (
        <div>
            ...
            <div className="w-fit h-24 border-devPurple border-solid border-2 rounded-2xl flex items-center gap-3 mr-6">
                {result.albumImageUrl != null ? (<><a target="_blank" href={result.songUrl}><img src={result.albumImageUrl} alt={`Image of ${result.title}`} className='w-20 h-20 rounded-xl ml-3' /></a>
