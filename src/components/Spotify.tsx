    ...
    return (
        <div>
            <div className="w-fit h-24 border-devPurple border-solid border-2 rounded-2xl flex items-center gap-3 mr-6">
                {result.albumImageUrl != null ? (<><a className='hovered' target="_blank" rel="noopener noreferrer" href={result.songUrl}><img src={result.albumImageUrl} alt={`Image of ${result.title}`} className='w-20 h-20 rounded-xl ml-3' /></a>
                ...
                <a href="https://open.spotify.com/user/paei6pn8u6ac9w2d42wkaohup?si=0bca6f6a59c24e52" className="hovered" target="_blank" rel="noopener noreferrer">
